  ...
  public defaults: any = {
    dashboard: {
      page: {
        ...
        desc: 'Dernières mises à jours d\'informations et de statistiques'
      },
    },
    ngbootstrap: {
      accordion: {
    ...
    ecommerce: {
      ...
      products: {
        edit: {
          page: {title: 'Modifier produit', desc: ''}
        },
        add: {
          page: {title: 'Formulaire d\'ajout de produit', desc: ''}
        }
      },
      orders: {
    ...
    profile: {
      page: {title: 'Profile Utilisateur', desc: ''}
    },
    error: {
      404: {
