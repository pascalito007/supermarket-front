...
import {
  ...
  CustomersStatusUpdated, selectCustomersInStore, CustomersService
...
export class CustomersListComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private store: Store<AppState>, private customerService: CustomersService
  ) {
  }
  ...
  editCustomer(customer: CustomerModel) {
    ...
    saveMessageTranslateParam += customer.id ? 'UPDATE_MESSAGE' : 'ADD_MESSAGE';
    const _saveMessage = this.translate.instant(saveMessageTranslateParam);
    const _messageType = customer.id ? MessageType.Update : MessageType.Create;
